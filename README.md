...
<a href="https://bolt-series.cn/prompt/">
  <img src="readmeImg/index.png" alt="Bolt Series Prompt 提示词库" width="100%" />
</a>
...
| **提示词管理** | 浏览器本地 **分组管理** 常用提示词：纳入、独立编辑、导入导出，打造你的专属提示词库 |
...
- **提示词管理**：本地分组与独立副本，适合把公用词条沉淀为个人常用工作集，并支持 JSON 备份。  
